...
function buildUserPrompt(payload) {
  ...
  return [
    ...
    "4. 你的职责是解释结果，不是改判结果。",
    "5. shortSummary 必须是一段 60~80 字的人格描述，只描述当前测试下的你，不写建议或 Top3 比较。",
    "6. shortSummary 要写得像日常性格观察，重点落在相处方式、表达习惯、拿主意时的状态、做事节奏这几个方面。",
    "7. shortSummary 至少写出 2 个具体行为倾向，用“更倾向、通常会、遇到……时往往”这类克制表达，不要空泛拔高。",
    "8. shortSummary 禁止成功学和职业画像口吻，避免“天生的领导者、强大执行力、战略、愿景、领导力、资源整合、总能”这类词。",
    "9. strengths 必须写成 3 条“优势信号”，解释维度如何转化为行为优势；不得直接照抄 axisSummaryLines，不得出现百分比、匹配度或 Top3 排名复述。",
    "10. 必须填写真实内容，不得照抄字段说明、示例文案、空字符串或占位数组。",
    "字段规范：",
    JSON.stringify(
      {
